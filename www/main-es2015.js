...
let GlobalService = class GlobalService {
                ...
                this.onWait(50, 60000, "onReadStatiqueEnable").then(() => {
                    ...
                    if (this.upcmodbus != undefined) {
                        this.storage.get("upcname").then(res => {
                            ...
                            this.logs.push(" - lectureCycliqueEnCours : " + this.lectureCycliqueEnCours);
                            const url = this.router.url;
                            const splittedUrl = url.split("/");
                            const urlFinal = splittedUrl[1];
    ...
    login() {
        return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.username = yield this.storage.get("user");
            this.password = yield this.storage.get("pass");
            // Request
    ...
    resetParameters() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var arr = yield Promise.all([
                ...
                yield this.storage.set("bottlesInTransit", ""),
...
let Upcv3serviceService = class Upcv3serviceService {
    ...
    updateBottleMobile(json, token) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.post(this.apiUrl + "/bottle/updateMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            switch (res.code) {
    ...
    getBottleByBarCode(barcode, token) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.get(this.apiUrl + "bottle/getBottleByBarcode/" + barcode, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            switch (res.code) {
    ...
    addBottleMobile(json, token) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token).set('Access-Control-Allow-Origin', '*');
        return this.http.post(this.apiUrl + "/bottle/addMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_CREATED:
                    console.log("La bouteille a bien été ajoutée");
                    break;
    ...
    createInterventionMobile(json, token) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.post(this.apiUrl + "upcv3/intervention/createMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].INTERVENTIONV3_CREATED:
                    alert("L'intervention a bien été enregistrée");
                    break;
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | bottle-types-modal-bottle-types-modal-module */ "bottle-types-modal-bottle-types-modal-module").then(__webpack_require__.bind(null, /*! ./bottle-types-modal/bottle-types-modal.module */ "./src/app/bottle-types-modal/bottle-types-modal.module.ts")).then(m => m.BottleTypesModalPageModule)
    }
];
...
class ModbusClient extends StateMachine {
    ...
    stringArrayToRegister(stringArray) {
...
class UPCModbus {
            ...
            switch (page) {
                case "synchro":
                    try {
                        ...
                        var res1 = yield this.client.readHoldingRegisters(correspondanceRegistres.diffHourSunRise.adr, 77);
                        //40068 40069
                      ...
                      alert("diff sunset :"+this.diffCo2Sunset)*/
                        ...
                        var res2 = yield this.client.readHoldingRegisters(correspondanceRegistres.upcMode.adr, 1);
                        console.log(":::::::::::::::::::UPC MODE :::::::::::::::::::::::::::::::::::::::");
                        console.log(res2);
                        var res2 = yield this.client.readHoldingRegisters(correspondanceRegistres.upcStatus.adr, 1);
                ...
                case "interventionceinture":
                    try {
                        //40001 40015
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcNameId.adr, 15);
                        //40001 40010
                        var tabname = [];
                        for (var i = 0; i < 10; i++) {
                            tabname.push(res1[i]);
                            ...
                            if (nameId != upcNameId) {
                                ...
                                if (window.confirm("Une intervention est en cours sur l'upc " +
                                    ...
                                    if (window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) {
                                        ...
                                        var res = yield this.readInterventionCeintureParameters();
                                        this.success = true;
                                        break;
                                    }
                                }
                    ...
                    try {
                        ...
                        if (mode != "modeTest") {
                            ...
                            if (false) { var res; }
                                ...
                                //40015
                                this.general.upcTrapNum = res1[14];
                                var res = yield this.readGeneralParameters();
                                this.success = true;
                                break;
                            }
                        }
                ...
                case "cdiff":
                    try {
                        //40001 40065
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcNameId.adr, 65);
                        //40001 40010
                        var tabname = [];
                        for (var i = 0; i < 10; i++) {
                            tabname.push(res1[i]);
                        ...
                        if (false) {}
                            ...
                            //40150
                            var res2 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.co2ResActAdj.adr, 1);
                ...
                case "comunicationparam":
                    try {
                        //40001 40064
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcNameId.adr, 64);
                        //40001 40010
                        var tabname = [];
                        for (var i = 0; i < 10; i++) {
                            tabname.push(res1[i]);
                        ...
                        if (mode != "modeTest") {
                            ...
                            if (nameId != upcNameId && false) {
                                ...
                                this.communicationParameters.comWiFiPass = this.client
                                    ...
                                    .replace(/[^a-zA-Z0-9-.-]/g, "");
                                var res2 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.comWebSrvUrl.adr, 46);
                                //40295 40310
                                var taburl = [];
                                for (var i = 0; i < 14; i++) {
                                    taburl.push(res2[i]);
                                ...
                                var res3 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.comMdmApnId2.adr, 51);
                                //40467 40517 0 50
                                var tabapn2 = [];
                                for (var i = 0; i < 50; i++) {
                                    tabapn2.push(res3[i]);
                ...
                case "connection":
                    ...
                    try {
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.comMdmMode.adr, 2);
                        this.connectionMode = res1[0];
                        this.connectionLevel = res1[1];
                        // statistiques :///////////////////////////////
                        var res1 = yield this.client.readHoldingRegisters(41219, 22);
                ...
                case "addbottleceint":
                    try {
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcNameId.adr, 10);
                        //40001 40010
                        var tabname = [];
                        for (var i = 0; i < 10; i++) {
                            tabname.push(res1[i]);
                        ...
                        if (mode != "modeTest") {
                            ...
                            if (nameId != upcNameId && false) {
                                ...
                                var res2 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.co2ResActive.adr, 16);
                                //40151
                ...
                case "alarmparam":
                    try {
                        //40001 40015
                        var res1 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcNameId.adr, 66);
                        //alert("res1 : "+res1)
                        //40001 40010
                        var tabname = [];
                        for (var i = 0; i < 10; i++) {
    ...
    readInterventionCeintureParameters() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //40168
                var res2 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcFwVer.adr, 1);
                //40168
                this.general.upcFwVer = this.client.registerToUint32([res2[0]]);
                //40401 40449
                var res3 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.comMdmMode.adr, 2);
    ...
    readGeneralParameters() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                this.general.upcFwVer = this.client.registerToUint32([res2[0]]);
                //40401 40449
                var res3 = yield this.client.readHoldingRegisters(this.correspondancesRegistres.upcTimeZone.adr, 48);
                //40401 40402
