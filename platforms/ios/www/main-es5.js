...
var GlobalService = /** @class */ (function () {
    function GlobalService(platform, loadingCTRL, upcv3Service, hotspot, ngZone, storage, upc3serv, toastCtrl, alertController, router, network, diagnostic, events) {
        ...
        this.contenuEnleveEnB2 = 0;
        this.addedBottlesB2 = { barcodes: [], contenus: [] };
        this.resetListeCodebarsB1 = false;
        this.resetListeCodebarsB2 = false;
        this.contenantInitialB1 = 0; //contenant de la réserve B1 à l'ouverture de la page
        this.contenantFinalB1 = 0; //capacité de la réserve B1 à la fin d'utilisation de la page (après ajout et enlèvement de bouteilles)
        this.contenantInitial = 0;
        this.contenantFinalB2 = 0;
        this.retryCount = 0;
    ...
    GlobalService.prototype.ConnectError = function () {
    ...
    GlobalService.prototype.UpcReadWriteError = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    GlobalService.prototype.UpcErrorCoAuto = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    GlobalService.prototype.checkNextPage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var urls, success, url, splittedUrl, urlFinal, sequence, pos;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        urls = [];
                        ...
                        urlFinal = splittedUrl[1];
                        return [4 /*yield*/, this.storage.get("sequence")];
                    case 1:
                        sequence = _a.sent();
    ...
    GlobalService.prototype.checkMode = function () {
        var response;
        switch (this.mode) {
            case "intervention":
    ...
    GlobalService.prototype.onConnect = function (error) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.connexionRequise == "UPC") {
                    ...
                    this.storage.get("ssid").then(function (res) {
                        _this.ssid = res;
                        var d = new Date();
                        _this.logs.push(_this.msToTime(d.getTime()) + " - ssid stocké : " + _this.ssid);
                                    ...
                                    case 1:
                                        ...
                                        if (this.ssid == undefined || this.ssid == "") { //ssid vide 
                                            ...
                                            this.onConnectModbus().then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                ...
                                                _this.logs.push(_this.msToTime(d.getTime()) + " - connexion Modbus échouée");
                                                _this.logs.push(_this.msToTime(d.getTime()) + " - présentation alerte connexion upc : ");
                                                if (!window.confirm("La connexion à l'UPC n'a pas pu être établie. Rapprochez-vous et raccordez-vous à l'UPC puis appuyez sur 'OK'.")) {
                                                    var d = new Date();
                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - réponse utilisateur : annuler");
                                                    _this.connexionRequise = "Aucune";
                                                    resolve("");
                                                }
                                                else {
                                                    var d = new Date();
                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - réponse utilisateur : OK");
                                                    resolve("");
                                                }
                                            });
                                        }
                                            ...
                                            if (this.currentssid == this.ssid) { //le ssid du réseau auquel on est connecté est le même que celui de la ceinture sélectionnée
                                                ...
                                                this.onConnectModbus().then(function () {
                                                    _this.appelOnConnectModbus = false;
                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion devient UPC");
                                                ...
                                                if (this.platform.is("android")) {
                                                    ...
                                                    this.logs.push(this.msToTime(d.getTime()) + " - ssid : " + this.ssid);
                                                    this.storage.get("password").then(function (res) {
                                                        var password = res;
                                                        var d = new Date();
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - appel wifiwizard2.connect()");
                                                        WifiWizard2.connect(_this.ssid, password).then(function () {
                                                            var d = new Date();
                                                            _this.logs.push(_this.msToTime(d.getTime()) + " - connected to upc wifi");
                                                            ...
                                                            _this.onConnectModbus().then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                                ...
                                                                _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : Aucune ");
                                                                _this.logs.push(_this.msToTime(d.getTime()) + " - présentation alerte connexion upc : ");
                                                                if (!window.confirm("La connexion à l'UPC n'a pas pu être établie. Rapprochez-vous et raccordez-vous à l'UPC puis appuyez sur 'OK'.")) {
                                                                    var d = new Date();
                                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - réponse utilisateur : annuler");
                                                        ...
                                                        }).catch(function () { var d = new Date(); _this.logs.push(_this.msToTime(d.getTime()) + " - fail connect"); });
                                                    });
                                                }
                                                else {
                                                    if (this.platform.is("ios")) {
                                                        ...
                                                        this.storage.get("password").then(function (res) {
                                                            var password = res;
                                                            var d4 = new Date();
                                                            _this.logs.push(_this.msToTime(d4.getTime()) + " - password : " + password);
                                                            _this.logs.push(_this.msToTime(d4.getTime()) + " - appel wifiwizard2 iOSConnectNetwork : " + password);
                                                            ...
                                                            }).catch(function (err) { var d = new Date(); _this.logs.push(_this.msToTime(d.getTime()) + " - fail connect :" + JSON.stringify(err)); });
                                                        });
                                                    }
                                                }
                                                //}                   
                                        ...
                                        if (this.ssid == undefined || this.ssid == "") { //ssid vide
                                            ...
                                            this.storage.get("password").then(function (res) {
                                                ...
                                                if (_this.platform.is("android")) {
                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - ssid : " + _this.ssid + " - password : " + password);
                                                    WifiWizard2.connect(_this.ssid, password).then(function (res) {
                                                        var d = new Date();
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - connexion au point d'accès réussie");
                                                        _this.currentssid = _this.ssid;
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - current ssid : " + _this.ssid);
                                                        _this.appelOnConnectModbus = true;
                                                        _this.onConnectModbus().then(function () {
                                                            var d = new Date();
                                                            _this.appelOnConnectModbus = false;
                                                            _this.logs.push(_this.msToTime(d.getTime()) + " - connexion Modbus réussie");
                                                            _this.logs.push(_this.msToTime(d.getTime()) + " - current ssid = ssid connecté");
                                                            _this.currentssid = _this.ssid;
                                                            _this.perteConnexion = false;
                                                            resolve("");
                                                        }).catch(function (err) {
                                                        ...
                                                        _this.statutConnexion = "Aucune";
                                                        var d = new Date();
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - connexion au point d'accès échouée : " + JSON.stringify(err));
                                                        _this.statutConnexion = "Aucune";
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : Aucune ");
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - présentation alerte connexion upc : ");
                                                        if (!window.confirm("La page a besoin d'être connecté à l'UPC. Connectez-vous à l'UPC puis appuyez sur 'OK'.")) {
                            ...
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        pass = _a.sent();
                                        //if(this.perteConnexion == true){
                                        this.logs.push(this.msToTime(d.getTime()) + " - appel wifiwizard2.connect() - wifi non connecté");
                ...
                if (this.connexionRequise == "Serveur") {
                    ...
                    if (error.status == 403) {
                        this.logs.push(this.msToTime(d.getTime()) + " - erreur 403");
    ...
    GlobalService.prototype.onReadStatiqueEnable = function () {
        var _this = this;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.ecritureEnCours == true || this.lectureCycliqueEnCours == true || this.onConnectEnCours == true || this.statutConnexion != "UPC") {
                    ...
                    this.onWait(50, 60000, "onReadStatiqueEnable").then(function () {
                        var d = new Date();
                        _this.logs.push(_this.msToTime(d.getTime()) + " - fin d'attente onReadStatique ");
                        //var d=new Date() 
                        ...
                        if (_this.upcmodbus != undefined) {
                            _this.storage.get("upcname").then(function (res) {
                                _this.upcname = res;
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - appel fonction onReadStatique");
                                _this.logs.push(_this.msToTime(d.getTime()) + " - lectureCycliqueEnCours : " + _this.lectureCycliqueEnCours);
                                var url = _this.router.url;
                                var splittedUrl = url.split("/");
                                var urlFinal = splittedUrl[1];
                                _this.logs.push(_this.msToTime(d.getTime()) + " - page : " + urlFinal);
                                /* reset des listes pour la page ajout de bouteilles */
                                if (_this.resetListeCodebarsB1 == true) {
                                    _this.codebarsB1 = [];
                                    _this.codebarsB1SansCodeUpc = [];
                                    _this.contenusB1 = [];
                                    _this.stringsB1 = [];
                                }
                                if (_this.resetListeCodebarsB2 == true) {
                                    _this.codebarsB2 = [];
                                    _this.codebarsB2SansCodeUpc = [];
                                    _this.contenusB2 = [];
                                    _this.stringsB2 = [];
                                }
                                _this.upcmodbus.onReadStatique(_this.upcname, _this.mode, urlFinal).then(function (res) {
                                    if (res == true) {
                                        ...
                                        if (res == "Terminer l'intervention en cours") {
                                            var d = new Date();
                                            _this.logs.push(_this.msToTime(d.getTime()) + " - Terminer l'intervention en cours");
                                            _this.router.navigate(["finintervention"]);
                                            _this.lectureStatiqueEnCours = false;
                                            _this.displayLoading = false;
                                            resolve();
                                        }
                                            ...
                                            if (res == "Abandonner l'intervention en cours") {
                                                var d = new Date();
                                                _this.logs.push(_this.msToTime(d.getTime()) + " - Abandonner l'intervention en cours");
                                                _this.resetParameters().then(function () {
                                                ...
                                                if (res == "Se rapprocher de l'upc") {
                                                    var d = new Date();
                                                    _this.logs.push(_this.msToTime(d.getTime()) + " - Se rapprocher de l'upc");
                                                    _this.displayLoading = false;
                                                    resolve();
                                                }
                                                else {
                                                    if (res.object.errCode != undefined) {
                                                        var d = new Date();
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - " + res.object.errCode + " - bloc :" + res.object.bloc);
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : Aucune ");
                                                        _this.statutConnexion = "Aucune";
                                                        ...
                                                        var d = new Date();
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - " + JSON.stringify(res.object) + " - bloc :" + res.object.bloc);
                                                        _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : Aucune ");
                                                        _this.statutConnexion = "Aucune";
                                                        //this.onConnect(res.object.errCode).then(res=>{
                                                        _this.lectureStatiqueEnCours = false;
                                    ...
                                    var d = new Date();
                                    _this.logs.push(_this.msToTime(d.getTime()) + " - catch onReadStatique : " + JSON.stringify(err) + "; on connect : " + _this.onConnectEnCours);
                            ...
                            var d = new Date();
                            _this.logs.push(_this.msToTime(d.getTime()) + " - upcmodbus undefined");
                            _this.lectureStatiqueEnCours = false;
                            _this.displayLoading = false;
                            resolve();
                        }
    ...
    GlobalService.prototype.onReadCycliqueEnable = function () {
        var _this = this;
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var d, d;
            var _this = this;
                ...
                if (this.statutConnexion == "UPC") {
                    ...
                    if (this.upcmodbus != undefined) {
                            ...
                            _this.upcmodbus.onReadCyclique(_this.upcname, _this.mode, urlFinal).then(function (res) {
                                if (res == true) {
                                    ...
                                    if (res.object.errCode != undefined) {
                                        ...
                                        _this.statutConnexion = "Aucune";
                                        if (_this.onConnectEnCours == false) {
                                            _this.onConnect(res.object.errCode).then(function (res) {
                                                _this.onConnectEnCours = false;
                                                resolve();
                                            });
                                        }
                                ...
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - catch onReadCyclique");
                                if (_this.onConnectEnCours == false) {
                                    _this.onConnect("UPC").then(function (res) {
                                        _this.onConnectEnCours = false;
                                        resolve();
                        ...
                        if (this.onConnectEnCours == false) {
                            this.onConnect("UPC").then(function () {
                                _this.onConnectEnCours = false;
                                resolve();
                            });
                        }
    ...
    GlobalService.prototype.onWriteEnable = function (variable, value) {
        var _this = this;
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var d, d, d, d, d;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                d = new Date();
                this.logs.push(this.msToTime(d.getTime()) + " - ON WRITE ");
                ...
                if (this.statutConnexion != "UPC" || this.lectureCycliqueEnCours == true || this.lectureStatiqueEnCours == true || this.onConnectEnCours == true) {
                    ...
                    this.onWait(50, 60000, "onWriteEnable").then(function () {
                        ...
                        if (variable.type == "int") {
                            _this.upcmodbus.client.setIntInHoldingRegister(variable.adr, variable.dim, value).then(function () {
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - écriture réussie");
                        ...
                        if (variable.type == "string") {
                            var d = new Date();
                            _this.logs.push(_this.msToTime(d.getTime()) + " - writemultipleregisters : " + _this.writeMultipleRegisters);
                            if (_this.writeMultipleRegisters == true) {
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - set string array in holding registers");
                    ...
                    if (variable.type == "string") {
                        d = new Date();
                        this.logs.push(this.msToTime(d.getTime()) + " - writemultipleregisters : " + this.writeMultipleRegisters);
                        if (this.writeMultipleRegisters == true) {
                            d = new Date();
                            this.logs.push(this.msToTime(d.getTime()) + " - set string array in holding registers");
    ...
    GlobalService.prototype.onWait = function (loopDelay, timeoutDelay, func) {
        var _this = this;
        var dx = new Date();
                    ...
                    case "onWriteEnable":
                        ...
                        this.intv = setInterval(function () {
                            ...
                            if (_this.statutConnexion == "UPC" && _this.lectureCycliqueEnCours != true && _this.ecritureEnCours != true && _this.onConnectEnCours != true) {
                                ...
                                _this.needToCheckFlags = false;
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - fin lecture en cours - écriture possible");
                        ...
                        setTimeout(function () {
                            if (_this.needToCheckFlags == true) {
                                if (_this.lectureCycliqueEnCours == true || _this.lectureStatiqueEnCours == true || _this.onConnectEnCours == true || _this.ecritureEnCours == true) {
                                    ...
                                    clearInterval(_this.intv);
                                    var d = new Date();
                                    _this.logs.push(_this.msToTime(d.getTime()) + " - écriture impossible - fin de timer");
                                    reject();
                                }
                            }
                        }, timeoutDelay);
                    ...
                    case "onReadStatiqueEnable":
                        this.intv = setInterval(function () {
                            if (_this.statutConnexion == "UPC" && _this.lectureCycliqueEnCours != true && _this.ecritureEnCours != true && _this.onConnectEnCours != true) {
                                ...
                                _this.needToCheckFlags = false;
                                var d = new Date();
                                _this.logs.push(_this.msToTime(d.getTime()) + " - lecture statique possible");
                                clearInterval(_this.intv);
                                resolve();
                            }
                        }, loopDelay);
                        setTimeout(function () {
                            if (_this.needToCheckFlags == true) {
                                if (_this.lectureCycliqueEnCours == true || _this.ecritureEnCours == true || _this.onConnectEnCours == true || _this.statutConnexion != "UPC") {
                                    ...
                                    clearInterval(_this.intv);
                                    var d = new Date();
                                    _this.logs.push(_this.msToTime(d.getTime()) + " - lecture statique impossible - fin de timer");
                                    reject();
                                }
                            }
                        }, timeoutDelay);
    ...
    GlobalService.prototype.onWait2 = function (loopDelay, timeoutDelay) {
        var _this = this;
        var dx = new Date();
        this.logs.push(this.msToTime(dx.getTime()) + " - entrée fonction ON WAIT 2");
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.needToCheckFlags = true;
    ...
    GlobalService.prototype.onConnectModbus = function () {
        var _this = this;
        var d = new Date();
        this.logs.push(this.msToTime(d.getTime()) + " - onConnectModbus");
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.upcmodbus != undefined) {
                    this.upcmodbus.client.close();
                    this.upcmodbus = new _model_upcv3_upcmodbus__WEBPACK_IMPORTED_MODULE_5__["UPCModbus"](function (state) {
                        if (_this.appelOnConnectModbus == true) {
                            _this.needToCheckState = true;
                            var d = new Date();
                            _this.logs.push(_this.msToTime(d.getTime()) + " - state : " + state);
                            var i_1 = setInterval(function () {
                                if (state == 1) {
                                    _this.statutConnexion = "UPC";
                                    var d = new Date();
                                    _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : UPC ");
                                    _this.needToCheckState = false;
                                    clearInterval(i_1);
                                    resolve();
                                }
                            }, 50);
                            setTimeout(function () {
                                if (_this.needToCheckState == true) {
                                    if (state == 1) {
                                        _this.statutConnexion = "UPC";
                                        var d = new Date();
                                        _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : UPC (fin de timer) ");
                                        _this.needToCheckState = false;
                                        clearInterval(i_1);
                                        resolve();
                                    }
                                        ...
                                        _this.statutConnexion = "Aucune";
                                        var d = new Date();
                                        _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : aucune (fin de timer) ");
                                        _this.needToCheckState = false;
                                        clearInterval(i_1);
                                        reject();
                                    }
                    ...
                    this.upcmodbus = new _model_upcv3_upcmodbus__WEBPACK_IMPORTED_MODULE_5__["UPCModbus"](function (state) {
                        if (_this.appelOnConnectModbus == true) {
                            ...
                            var d = new Date();
                            _this.logs.push(_this.msToTime(d.getTime()) + " - state : " + state);
                            var i_2 = setInterval(function () {
                                if (state == 1) {
                                    _this.statutConnexion = "UPC";
                                    var d = new Date();
                                    _this.logs.push(_this.msToTime(d.getTime()) + " - statut connexion : UPC ");
                                    _this.needToCheckState = false;
                                    _this.storage.set("ssid", _this.currentssid);
                                    clearInterval(i_2);
                                    resolve();
                                }
                                else {
    ...
    GlobalService.prototype.resetParameters = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var arr, _a, _b, _c;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _b = (_a = Promise).all;
                        return [4 /*yield*/, this.storage.set("motiveItems", "")];
                    case 1:
                        _c = [
                            _d.sent()
                        ];
                        return [4 /*yield*/, this.storage.set("motiveString", "")];
                    case 2:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("intervenantsItems", "")];
                    case 3:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("intervenantsString", "")];
                    case 4:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("ceintureChoisieObject", "")];
                    case 5:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("ssid", "")];
                    case 6:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.storage.set("currentssid", "")];
                    case 8:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("currentpassword", "")];
                    case 9:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("upcname", "")];
                    case 10:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("stockBottleTypes", "")];
                    case 11:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("bottlesInTransit", "")];
                    case 12:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("ceintureChoisieBottles", "")];
                    case 13:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("commentaires", "")];
                    case 14:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("dataAlreadyLoaded", "false")];
                    case 15:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("json", "")];
                    case 16:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("isCeintureSelected", false)];
                    case 17:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("isInterventionEnCours", false)];
                    case 18:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("isInterventionNotSaved", false)];
                    case 19:
                        _c = _c.concat([
                            _d.sent()
                        ]);
                        return [4 /*yield*/, this.storage.set("sequence", "")];
                    case 20: return [4 /*yield*/, _b.apply(_a, [_c.concat([
                                _d.sent()
                            ])])];
                    case 21:
                        arr = _d.sent();
    ...
    GlobalService.prototype.msToTime = function (duration) {
        var milliseconds;
        var seconds;
        var minutes;
        var hours;
...
var NetworkService = /** @class */ (function () {
    function NetworkService(network, eventCtrl, ngZone) {
        this.network = network;
...
var Upcv3serviceService = /** @class */ (function () {
    //local api to test new Backend 
    //private apiUrl = 'http://192.168.1.41:8080/';
        ...
        return this.http.get(this.apiUrl + 'upcv3/all', { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].UPCV3_RECOVERED:
                    var upcv3 = [];
                    var i = 0;
                    res.result.forEach(function (jsonUPCV3) { upcv3.push(_model_upcv3_upcv3__WEBPACK_IMPORTED_MODULE_4__["UPCV3"].loadFromJSON(jsonUPCV3)); });
                    res.result = upcv3;
                    break;
    ...
    Upcv3serviceService.prototype.createIntervention = function (json, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.post(this.apiUrl + "upcv3/intervention/createAdmin", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
    ...
    Upcv3serviceService.prototype.updateBottleMobile = function (json, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.post(this.apiUrl + "/bottle/updateMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_RECOVERED:
                    console.log("La bouteille a bien été mise à jour");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].UNAUTHORIZED:
                    alert("Non Autorisé");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_DOESNT_EXSIST:
                    alert("La bouteille n'existe pas");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].INTERNAL_ERROR:
                    alert("Erreur Interne");
                    break;
    ...
    Upcv3serviceService.prototype.getBottleByBarCode = function (barcode, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.get(this.apiUrl + "bottle/getBottleByBarcode/" + barcode, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_CREATED:
                    console.log("La bouteille a bien été ajoutée");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].UNAUTHORIZED:
                    alert("Non Autorisé");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_TYPE_DOESNT_EXSIST:
                    alert("Le type de bouteille n'existe pas");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].STOCK_DOESNT_EXSIST:
                    alert("L'entrepôt n'existe pas");
                    break;
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].INTERNAL_ERROR:
                    alert("Erreur Interne");
                    break;
    ...
    Upcv3serviceService.prototype.addBottleMobile = function (json, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token).set('Access-Control-Allow-Origin', '*');
        return this.http.post(this.apiUrl + "/bottle/addMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].BOTTLE_CREATED:
                    console.log("La bouteille a bien été ajoutée");
                    break;
    ...
    Upcv3serviceService.prototype.createInterventionMobile = function (json, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.post(this.apiUrl + "upcv3/intervention/createMobile", json, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
                case _ApiResponse__WEBPACK_IMPORTED_MODULE_5__["Code"].INTERVENTIONV3_CREATED:
                    alert("L'intervention a bien été enregistrée");
                    break;
    ...
    Upcv3serviceService.prototype.getConnected = function (token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.get(this.apiUrl + "operator/getConnected", { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
    ...
    Upcv3serviceService.prototype.getActionNotDoneById = function (token, id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.get(this.apiUrl + "upcv3/intervention/isActionDoneById/" + id, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
    ...
    Upcv3serviceService.prototype.getAllBottleTypes = function (token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
    ...
    Upcv3serviceService.prototype.getSitesByUpcID = function (id, token) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('authorization', 'Bearer ' + token);
        return this.http.get(this.apiUrl + 'upcv3/getSiteByUpcID/' + id, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            switch (res.code) {
...
var routes = [
    ...
    {
        path: 'instalpieges',
        loadChildren: function () { return Promise.all(/*! import() | instalpieges-instalpieges-module */[__webpack_require__.e("default~canvas-canvas-module~instalpieges-instalpieges-module"), __webpack_require__.e("instalpieges-instalpieges-module")]).then(__webpack_require__.bind(null, /*! ./instalpieges/instalpieges.module */ "./src/app/instalpieges/instalpieges.module.ts")).then(function (m) { return m.InstalpiegesPageModule; }); }
    },
    {
        path: 'bottles',
        loadChildren: function () { return __webpack_require__.e(/*! import() | bottles-bottles-module */ "bottles-bottles-module").then(__webpack_require__.bind(null, /*! ./bottles/bottles.module */ "./src/app/bottles/bottles.module.ts")).then(function (m) { return m.BottlesPageModule; }); }
    },
    {
        path: 'bottlemodal',
    ...
    {
        path: 'optionbottle',
        loadChildren: function () { return Promise.all(/*! import() | optionbottle-optionbottle-module */[__webpack_require__.e("default~addbottlemodal-addbottlemodal-module~optionbottle-optionbottle-module~retfournmodal-retfourn~a03ae8d9"), __webpack_require__.e("common"), __webpack_require__.e("optionbottle-optionbottle-module")]).then(__webpack_require__.bind(null, /*! ./optionbottle/optionbottle.module */ "./src/app/optionbottle/optionbottle.module.ts")).then(function (m) { return m.OptionbottlePageModule; }); }
    },
    {
        path: 'stock',
        loadChildren: function () { return Promise.all(/*! import() | stock-stock-module */[__webpack_require__.e("default~addbottlemodal-addbottlemodal-module~optionbottle-optionbottle-module~retfournmodal-retfourn~a03ae8d9"), __webpack_require__.e("stock-stock-module")]).then(__webpack_require__.bind(null, /*! ./stock/stock.module */ "./src/app/stock/stock.module.ts")).then(function (m) { return m.StockPageModule; }); }
    },
    {
        path: 'addbottlemodal',
        loadChildren: function () { return Promise.all(/*! import() | addbottlemodal-addbottlemodal-module */[__webpack_require__.e("default~addbottlemodal-addbottlemodal-module~optionbottle-optionbottle-module~retfournmodal-retfourn~a03ae8d9"), __webpack_require__.e("addbottlemodal-addbottlemodal-module")]).then(__webpack_require__.bind(null, /*! ./addbottlemodal/addbottlemodal.module */ "./src/app/addbottlemodal/addbottlemodal.module.ts")).then(function (m) { return m.AddbottlemodalPageModule; }); }
    },
    {
        path: 'addbottleceint',
        loadChildren: function () { return __webpack_require__.e(/*! import() | addbottleceint-addbottleceint-module */ "addbottleceint-addbottleceint-module").then(__webpack_require__.bind(null, /*! ./addbottleceint/addbottleceint.module */ "./src/app/addbottleceint/addbottleceint.module.ts")).then(function (m) { return m.AddbottleceintPageModule; }); }
    },
    {
        path: 'rackcontent',
    ...
    {
        path: 'adjustment',
        loadChildren: function () { return __webpack_require__.e(/*! import() | adjustment-adjustment-module */ "adjustment-adjustment-module").then(__webpack_require__.bind(null, /*! ./adjustment/adjustment.module */ "./src/app/adjustment/adjustment.module.ts")).then(function (m) { return m.AdjustmentPageModule; }); }
    },
    {
        path: 'check',
        loadChildren: function () { return __webpack_require__.e(/*! import() | check-check-module */ "check-check-module").then(__webpack_require__.bind(null, /*! ./check/check.module */ "./src/app/check/check.module.ts")).then(function (m) { return m.CheckPageModule; }); }
    },
    {
        path: 'controldiff',
        loadChildren: function () { return __webpack_require__.e(/*! import() | controldiff-controldiff-module */ "controldiff-controldiff-module").then(__webpack_require__.bind(null, /*! ./controldiff/controldiff.module */ "./src/app/controldiff/controldiff.module.ts")).then(function (m) { return m.ControldiffPageModule; }); }
    },
    {
        path: 'synchro',
        loadChildren: function () { return __webpack_require__.e(/*! import() | synchro-synchro-module */ "synchro-synchro-module").then(__webpack_require__.bind(null, /*! ./synchro/synchro.module */ "./src/app/synchro/synchro.module.ts")).then(function (m) { return m.SynchroPageModule; }); }
    },
    {
        path: 'cdiff',
        loadChildren: function () { return __webpack_require__.e(/*! import() | cdiff-cdiff-module */ "cdiff-cdiff-module").then(__webpack_require__.bind(null, /*! ./cdiff/cdiff.module */ "./src/app/cdiff/cdiff.module.ts")).then(function (m) { return m.CdiffPageModule; }); }
    },
    {
        path: 'connection',
        loadChildren: function () { return __webpack_require__.e(/*! import() | connection-connection-module */ "connection-connection-module").then(__webpack_require__.bind(null, /*! ./connection/connection.module */ "./src/app/connection/connection.module.ts")).then(function (m) { return m.ConnectionPageModule; }); }
    },
    {
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | interventionceinture2-interventionceinture2-module */ "interventionceinture2-interventionceinture2-module").then(__webpack_require__.bind(null, /*! ./interventionceinture2/interventionceinture2.module */ "./src/app/interventionceinture2/interventionceinture2.module.ts")).then(function (m) { return m.Interventionceinture2PageModule; }); }
    },
    {
        path: 'retfournmodal',
        loadChildren: function () { return Promise.all(/*! import() | retfournmodal-retfournmodal-module */[__webpack_require__.e("default~addbottlemodal-addbottlemodal-module~optionbottle-optionbottle-module~retfournmodal-retfourn~a03ae8d9"), __webpack_require__.e("common"), __webpack_require__.e("retfournmodal-retfournmodal-module")]).then(__webpack_require__.bind(null, /*! ./retfournmodal/retfournmodal.module */ "./src/app/retfournmodal/retfournmodal.module.ts")).then(function (m) { return m.RetfournmodalPageModule; }); }
    },
    {
        path: 'namepiege',
        loadChildren: function () { return __webpack_require__.e(/*! import() | namepiege-namepiege-module */ "namepiege-namepiege-module").then(__webpack_require__.bind(null, /*! ./namepiege/namepiege.module */ "./src/app/namepiege/namepiege.module.ts")).then(function (m) { return m.NamepiegePageModule; }); }
    },
    {
        path: 'comunicationparam',
        loadChildren: function () { return __webpack_require__.e(/*! import() | comunicationparam-comunicationparam-module */ "comunicationparam-comunicationparam-module").then(__webpack_require__.bind(null, /*! ./comunicationparam/comunicationparam.module */ "./src/app/comunicationparam/comunicationparam.module.ts")).then(function (m) { return m.ComunicationparamPageModule; }); }
    },
    {
        path: 'alarmparam',
        loadChildren: function () { return __webpack_require__.e(/*! import() | alarmparam-alarmparam-module */ "alarmparam-alarmparam-module").then(__webpack_require__.bind(null, /*! ./alarmparam/alarmparam.module */ "./src/app/alarmparam/alarmparam.module.ts")).then(function (m) { return m.AlarmparamPageModule; }); }
    },
    {
        path: 'initechangeboitierupc',
        loadChildren: function () { return __webpack_require__.e(/*! import() | initechangeboitierupc-initechangeboitierupc-module */ "initechangeboitierupc-initechangeboitierupc-module").then(__webpack_require__.bind(null, /*! ./initechangeboitierupc/initechangeboitierupc.module */ "./src/app/initechangeboitierupc/initechangeboitierupc.module.ts")).then(function (m) { return m.InitechangeboitierupcPageModule; }); }
    },
    {
        path: 'commentaires',
        loadChildren: function () { return __webpack_require__.e(/*! import() | commentaires-commentaires-module */ "commentaires-commentaires-module").then(__webpack_require__.bind(null, /*! ./commentaires/commentaires.module */ "./src/app/commentaires/commentaires.module.ts")).then(function (m) { return m.CommentairesPageModule; }); }
    },
    {
        path: 'rapportvisite',
        loadChildren: function () { return __webpack_require__.e(/*! import() | rapportvisite-rapportvisite-module */ "rapportvisite-rapportvisite-module").then(__webpack_require__.bind(null, /*! ./rapportvisite/rapportvisite.module */ "./src/app/rapportvisite/rapportvisite.module.ts")).then(function (m) { return m.RapportvisitePageModule; }); }
    },
    {
        path: 'modifnbpieges',
        loadChildren: function () { return __webpack_require__.e(/*! import() | modifnbpieges-modifnbpieges-module */ "modifnbpieges-modifnbpieges-module").then(__webpack_require__.bind(null, /*! ./modifnbpieges/modifnbpieges.module */ "./src/app/modifnbpieges/modifnbpieges.module.ts")).then(function (m) { return m.ModifnbpiegesPageModule; }); }
    },
    {
        path: 'verifpiegesindividuels',
        loadChildren: function () { return __webpack_require__.e(/*! import() | verifpiegesindividuels-verifpiegesindividuels-module */ "verifpiegesindividuels-verifpiegesindividuels-module").then(__webpack_require__.bind(null, /*! ./verifpiegesindividuels/verifpiegesindividuels.module */ "./src/app/verifpiegesindividuels/verifpiegesindividuels.module.ts")).then(function (m) { return m.VerifpiegesindividuelsPageModule; }); }
    },
    {
        path: 'testmode',
        loadChildren: function () { return __webpack_require__.e(/*! import() | testmode-testmode-module */ "testmode-testmode-module").then(__webpack_require__.bind(null, /*! ./testmode/testmode.module */ "./src/app/testmode/testmode.module.ts")).then(function (m) { return m.TestmodePageModule; }); }
    },
    {
        path: 'finintervention',
        loadChildren: function () { return __webpack_require__.e(/*! import() | finintervention-finintervention-module */ "finintervention-finintervention-module").then(__webpack_require__.bind(null, /*! ./finintervention/finintervention.module */ "./src/app/finintervention/finintervention.module.ts")).then(function (m) { return m.FininterventionPageModule; }); }
    },
    {
        path: 'debug',
        loadChildren: function () { return __webpack_require__.e(/*! import() | debug-debug-module */ "debug-debug-module").then(__webpack_require__.bind(null, /*! ./debug/debug.module */ "./src/app/debug/debug.module.ts")).then(function (m) { return m.DebugPageModule; }); }
    },
    {
        path: 'bottle-types-modal',
        loadChildren: function () { return __webpack_require__.e(/*! import() | bottle-types-modal-bottle-types-modal-module */ "bottle-types-modal-bottle-types-modal-module").then(__webpack_require__.bind(null, /*! ./bottle-types-modal/bottle-types-modal.module */ "./src/app/bottle-types-modal/bottle-types-modal.module.ts")).then(function (m) { return m.BottleTypesModalPageModule; }); }
    }
];
...
module.exports = ".normal {\n  color: light;\n}\n\n.perteConnexion {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, router, upcv3Service, global, hotspot, ngZone, networkProvider, events, network, cd, alertController, storage) {
        var _this = this;
        this.platform = platform;
        ...
        this.platform.ready().then(function (res) {
            ...
            setInterval(function () {
                var d = new Date();
                _this.global.logs.push(_this.global.msToTime(d.getTime()) + " - set interval");
                return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var d, d, d, d;
                    var _this = this;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        ...
                        if (this.global.connexionRequise == "UPC") {
                            ...
                            if (this.global.lectureCycliqueEnCours != true) {
                                ...
                                if (this.global.ecritureEnCours == true || this.global.lectureStatiqueEnCours == true || this.global.onConnectEnCours == true) {
                                    ...
                                    this.global.onReadCycliqueEnable().then(function () {
                                        _this.global.lectureCycliqueEnCours = false;
                                        resolve();
                                    });
                                }
                            }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                    text: 'NON',
                                    handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                localStorage.clear();
                                                this.stockRet = "";
                                                return [4 /*yield*/, this.storage.remove("motive")];
                                            case 1:
                                                _a.sent();
                                                return [4 /*yield*/, this.storage.remove("intervenantsChoisis")];
                                            case 2:
                                                _a.sent();
                                                return [4 /*yield*/, this.storage.remove("ceintureChoisieName")];
                                            case 3:
                                                _a.sent();
                                                return [4 /*yield*/, this.storage.remove("ceintureChoisieObject")];
                                            case 4:
                                                _a.sent();
                                                return [4 /*yield*/, this.storage.remove("nearUpcList")];
                                            case 5:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
    ...
    AppComponent.prototype.onClearInterval = function (url) {
        clearInterval(this.global.interval);
        this.router.navigate([url]);
        this.events.unsubscribe("loadParameters");
        // version_id project_id 
    };
    AppComponent.prototype.goToConn = function () {
...
var CorrespondancesRegistres = /** @class */ (function () {
    function CorrespondancesRegistres() {
    ...
    return CorrespondancesRegistres;
}());
...
var ModbusClient = /** @class */ (function (_super) {
    ...
    function ModbusClient(timeout, autoreconnect, verbose) {
        if (timeout === void 0) { timeout = 32000; }
    ...
    ModbusClient.prototype.stringArrayToRegister = function (stringArray) {
        var _this = this;
        var registersArrayTmp = []; //tableau de tableau de int
        var registersArray = []; //tableau de int
        //alert("stringArray : "+stringArray)
        //alert("elements : ")
        stringArray.forEach(function (element) {
            //alert(this.stringToRegister(element))
            registersArrayTmp.push(_this.stringToRegister(element));
        });
        //alert("registersArray : "+registersArrayTmp)
        registersArrayTmp.forEach(function (element) {
...
var UPCModbus = /** @class */ (function () {
    ...
    UPCModbus.prototype.onReadCyclique = function (upcNameId, mode, page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var success, error, correspondanceRegistres, _a, res, err_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = page;
                        switch (_a) {
                            case "interventionceinture": return [3 /*break*/, 1];
                            case "namepiege": return [3 /*break*/, 2];
                            case "cdiff": return [3 /*break*/, 3];
                            case "comunicationparam": return [3 /*break*/, 6];
                            case "addbottleceint": return [3 /*break*/, 7];
                            case "synchro": return [3 /*break*/, 8];
                            case "alarmparam": return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 10];
                    case 1:
                        success = true;
    ...
    UPCModbus.prototype.onReadStatique = function (upcNameId, mode, page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var success, error, correspondanceRegistres, opt, _a, res1, tabname, i, nameId, res, res, res, err_2, res1, tabname, i, nameId, res, res, res, err_3, res1, tabname, i, nameId, res2, res3, res2, res3, err_4, res1, tabname, i, nameId, tabMdmName, i, tabMdmPass, i, tabssid, i, tabpassword, i, res2, taburl, i, tabapnuser, i, tabapnpass, i, res3, tabapn2, i, tabMdmName, i, tabMdmPass, i, tabssid, i, tabpassword, i, res2, taburl, i, tabapnuser, i, tabapnpass, i, res3, tabapn2, i, err_5, res1, tabname, i, nameId, res2, res3, res4, tabB11, i, tabB12, i, tabB13, i, tabB14, i, tabB15, i, tabB16, i, tabB17, i, tabB18, i, tabB19, i, tabB21, i, tabB22, i, tabB23, i, tabB24, i, tabB25, i, tabB26, i, tabB27, i, tabB28, i, tabB29, i, res2, res3, res4, tabB11, i, tabB12, i, tabB13, i, tabB14, i, tabB15, i, tabB16, i, tabB17, i, tabB18, i, tabB19, i, tabB21, i, tabB22, i, tabB23, i, tabB24, i, tabB25, i, tabB26, i, tabB27, i, tabB28, i, tabB29, i, err_6, res1, res2, err_7, res1, tabname, i, nameId, res, res, res, err_8;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case "interventionceinture": return [3 /*break*/, 1];
                            case "namepiege": return [3 /*break*/, 15];
                            case "cdiff": return [3 /*break*/, 29];
                            case "comunicationparam": return [3 /*break*/, 40];
                            case "addbottleceint": return [3 /*break*/, 51];
                            case "synchro": return [3 /*break*/, 64];
                            case "alarmparam": return [3 /*break*/, 68];
                        }
                        return [3 /*break*/, 82];
                    case 1:
                    ...
                    case 2:
                        ...
                        if (!(mode != "modeTest")) return [3 /*break*/, 11];
                        if (!(nameId != upcNameId)) return [3 /*break*/, 8];
                        if (!window.confirm("Une intervention est en cours sur l'upc " + upcNameId + ". Voulez-vous néanmoins continuer sur l'upc " + nameId + "?")) return [3 /*break*/, 6];
                        if (!window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) return [3 /*break*/, 3];
                        return [2 /*return*/, { success: true, object: "Terminer l'intervention en cours" }];
                    case 3: return [4 /*yield*/, this.readInterventionCeintureParameters()];
                    case 4:
                        res = _b.sent();
                        this.success = true;
                        return [3 /*break*/, 82];
                    ...
                    case 8:
                        this.nameId = nameId;
                        //40011
                        this.general.upcMode = res1[10];
                        //40015
                        this.general.upcTrapNum = res1[14];
                        return [4 /*yield*/, this.readInterventionCeintureParameters()];
                    case 9:
                        res = _b.sent();
                        this.success = true;
                        return [3 /*break*/, 82];
                    ...
                    case 16:
                        ...
                        nameId = this.client.registerToString(tabname).replace(/[^a-zA-Z0-9]/g, '');
                        if (!(mode != "modeTest")) return [3 /*break*/, 25];
                        if (!(nameId != upcNameId)) return [3 /*break*/, 22];
                        if (!window.confirm("Une intervention est en cours sur l'upc " + upcNameId + ". Voulez-vous néanmoins continuer sur l'upc " + nameId + "?")) return [3 /*break*/, 20];
                        if (!window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) return [3 /*break*/, 17];
                        return [2 /*return*/, { success: true, object: "Terminer l'intervention en cours" }];
                    case 17: return [4 /*yield*/, this.readGeneralParameters()];
                    case 18:
                        res = _b.sent();
                        this.success = true;
                        return [3 /*break*/, 82];
                    ...
                    case 30:
                        ...
                        nameId = this.client.registerToString(tabname).replace(/[^a-zA-Z0-9]/g, '');
                        if (!(mode != "modeTest")) return [3 /*break*/, 35];
                        if (!(nameId != upcNameId)) return [3 /*break*/, 31];
                    ...
                    case 41:
                        ...
                        if (!(nameId != upcNameId)) return [3 /*break*/, 42];
                        if (window.confirm("Une intervention est en cours sur l'upc " + upcNameId + ". Voulez-vous néanmoins continuer sur l'upc " + nameId + "?")) {
                            if (window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) {
                                return [2 /*return*/, { success: true, object: "Terminer l'intervention en cours" }];
                            }
                    ...
                    case 52:
                        ...
                        nameId = this.client.registerToString(tabname).replace(/[^a-zA-Z0-9]/g, '');
                        if (!(mode != "modeTest")) return [3 /*break*/, 58];
                        if (!(nameId != upcNameId)) return [3 /*break*/, 53];
                        if (window.confirm("Une intervention est en cours sur l'upc " + upcNameId + ". Voulez-vous néanmoins continuer sur l'upc " + nameId + "?")) {
                            if (window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) {
                                return [2 /*return*/, { success: true, object: "Terminer l'intervention en cours" }];
                            }
                    ...
                    case 65:
                        ...
                        return [4 /*yield*/, this.client.readHoldingRegisters(correspondanceRegistres.upcStatus.adr, 1)];
                    case 66:
                        res2 = _b.sent();
                    ...
                    case 69:
                        ...
                        nameId = this.client.registerToString(tabname).replace(/[^a-zA-Z0-9]/g, '');
                        if (!(mode != "modeTest")) return [3 /*break*/, 78];
                        if (!(nameId != upcNameId)) return [3 /*break*/, 75];
                        if (!window.confirm("Une intervention est en cours sur l'upc " + upcNameId + ". Voulez-vous néanmoins continuer sur l'upc " + nameId + "?")) return [3 /*break*/, 73];
                        if (!window.confirm("Voulez-vous terminer l'intervention ? (OK) ou l'abandonner ? (Annuler)")) return [3 /*break*/, 70];
                        return [2 /*return*/, { success: true, object: "Terminer l'intervention en cours" }];
                    case 70:
    ...
    UPCModbus.prototype.readInterventionCeintureParameters = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UPCModbus.prototype.readAlarmParameters = function () {
        var _this = this;
        return new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var res2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UPCModbus.prototype.hexaToDecimal = function (hexa) {
        var decimal = parseInt(hexa, 16);
        return decimal;
    };
    UPCModbus.prototype.decimalToHexa = function (decimal) {
        var hexa = (decimal - 0).toString(16);
        return hexa;
    };
    UPCModbus.prototype.readDiffusionParams = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    ...
    UPCModbus.prototype.readAllRegOld = function (upcNameId, mode, page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var repBloc1, repBloc2, repBloc3, repBloc4, repBloc5, repBloc6;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readBloc1(upcNameId, mode)];
                    case 1:
                        repBloc1 = _a.sent();
                        if (!(repBloc1.success == true)) return [3 /*break*/, 18];
                        return [2 /*return*/, true];
                    case 2:
                        if (!(repBloc1.object == "Abandonner l'intervention en cours")) return [3 /*break*/, 3];
                        return [2 /*return*/, "Abandonner l'intervention en cours"];
                    case 3:
                        if (!(repBloc1.object == "Se rapprocher de l'upc")) return [3 /*break*/, 4];
                        return [2 /*return*/, "Se rapprocher de l'upc"];
                    case 4: return [4 /*yield*/, this.readBloc2()];
                    case 5:
                        repBloc2 = _a.sent();
                        if (!(repBloc2.success == true)) return [3 /*break*/, 16];
                        return [4 /*yield*/, this.readBloc3()];
                    case 6:
                        repBloc3 = _a.sent();
                        if (!(repBloc3.success == true)) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.readBloc4()];
                    case 7:
                        repBloc4 = _a.sent();
                        if (!(repBloc4.success == true)) return [3 /*break*/, 12];
                        return [4 /*yield*/, this.readBloc5()];
                    case 8:
                        repBloc5 = _a.sent();
                        if (!(repBloc5.success == true)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.readBloc6()];
                    case 9:
                        repBloc6 = _a.sent();
                        if (repBloc6.success == true) {
                            ...
                            return [2 /*return*/, repBloc6]; //retourne l'erreur du bloc 6
                        }
                        return [3 /*break*/, 11];
                    case 10: return [2 /*return*/, repBloc5]; //retourne l'erreur du bloc 5
                    case 11: return [3 /*break*/, 13];
                    case 12: return [2 /*return*/, repBloc4]; //retourne l'erreur du bloc 4
                    case 13: return [3 /*break*/, 15];
                    case 14: return [2 /*return*/, repBloc3]; //retourne l'erreur du bloc 3
                    case 15: return [3 /*break*/, 17];
                    case 16: return [2 /*return*/, repBloc2]; //retourne l'erreur du bloc 2
                    case 17: return [3 /*break*/, 19];
                    case 18: return [2 /*return*/, repBloc1]; //retourne l'erreur du bloc 1
                    case 19: return [2 /*return*/];
                }
            });
        });
    };
    UPCModbus.prototype.onConfirm = function (buttonIndex) {
        if (buttonIndex == 0) {
            this.answer = 0;
        }
        if (buttonIndex == 1) {
    ...
    UPCModbus.prototype.readBloc2 = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var res;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.readHoldingRegisters(40122, 120)];
                    case 1:
                        res = _a.sent();
                        try {
                            //40122 40123
                            ...
                            return [2 /*return*/, { success: false, object: err, bloc: 2 }];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    UPCModbus.prototype.readGeneralParametersOld = function () {
        var _this = this;
...
module.exports = __webpack_require__(/*! C:\Users\devel\OneDrive\Bureau\b-Dev\src\main.ts */"./src/main.ts");
