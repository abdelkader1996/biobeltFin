...
var StockPage = /** @class */ (function () {
    ...
    StockPage.prototype.scanBottle = function () {
        ...
        if (this.retbouteille) {
            this.upcv3Service.getBottleByBarCode("43770929851162", this.token).subscribe(function (res) {
    ...
    StockPage.prototype.retraitdebouteille = function () {
        ...
        this.upcv3Service.addBottleMobile(JSON.stringify(this.botteilleRet), this.token).subscribe(function (res) { return console.log(res.code); });
    };
    ...
    StockPage.prototype.addBottle = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                */
                this.bottleBarcodes.map(function (item, index) {
                    var bottle = {
                        barcode: item,
                    ...
                    // mettre a jour la bouteille  dans la base de données :
                    _this.upcv3Service.addBottleMobile(JSON.stringify(bottle), _this.token).subscribe(function (res) { return console.log(res.code); });
                });
                return [2 /*return*/];
            });
        });
