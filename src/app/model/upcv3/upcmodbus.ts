...
export class UPCModbus {
      ...
      case "synchro":
        try {
          ...
          var res1 = await this.client.readHoldingRegisters(
            correspondanceRegistres.diffHourSunRise.adr,
            77
          );
          //40068 40069
        ...
        alert("diff sunset :"+this.diffCo2Sunset)*/
          ...
          //40095
          this.diffCo2Program[3].intensity = this.client.registerToUint32(
            res1[27]
          );
          ...
          //40101
          this.diffCo2Program[4].intensity = this.client.registerToUint32(
            res1[33]
          );
          ...
          //40131
          this.diffCo2Program[9].intensity = this.client.registerToUint32(
            res1[63]
          );
          ...
          console.log(res2);
          var res2 = await this.client.readHoldingRegisters(
            correspondanceRegistres.upcStatus.adr,
            1
          );
          console.log(
            ":::::::::::::::::::UPC Statu :::::::::::::::::::::::::::::::::::::::"
            ...
            if (nameId != upcNameId) {
              ...
              if (
                ...
                if (
                  ...
                  var res = await this.readInterventionCeintureParameters();
                  this.success = true;
        ...
        try {
          ...
          if (mode != "modeTest") {
            ...
            if (nameId != upcNameId && false) {
              ...
              //40022 40023
              this.communicationParameters.comGsmIpAdr = this.int2ip(
                this.client.registerToUint32([res1[21], res1[22]])
              );
              ...
              var res2 = await this.client.readHoldingRegisters(
                this.correspondancesRegistres.comWebSrvUrl.adr,
                46
              );
              ...
              var res3 = await this.client.readHoldingRegisters(
                this.correspondancesRegistres.comMdmApnId2.adr,
                51
              );
        ...
        try {
          ...
          if (mode != "modeTest") {
            ...
            if (nameId != upcNameId && false) {
              ...
              var res2 = await this.client.readHoldingRegisters(
                this.correspondancesRegistres.co2ResActive.adr,
                16
              );
              ...
              this.reserves.co2Res1ActVol =
                Math.round(
                  this.client.registerToFloat([res2[6], res2[7]]) *
                    0.001974 *
                    100
                ) / 100;
              ...
              this.reserves.co2Res1StartVol =
                Math.round(
                  this.client.registerToFloat([res3[45], res3[46]]) *
                    0.001974 *
                    100
                ) / 100;
              ...
              var res4 = await this.client.readHoldingRegisters(
                this.correspondancesRegistres.xCo2Res1CodesBarres.adr,
                90
              );
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB11)
              );
              //41129 41133
              var tabB12 = [];
              for (var i = 5; i < 10; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB12)
              );
              //41134 41138
              var tabB13 = [];
              for (var i = 10; i < 15; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB13)
              );
              //41139 41143
              var tabB14 = [];
              for (var i = 15; i < 20; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB14)
              );
              //41144 41148
              var tabB15 = [];
              for (var i = 20; i < 25; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB15)
              );
              //41149 41153
              var tabB16 = [];
              for (var i = 25; i < 30; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB16)
              );
              //41154 41158
              var tabB17 = [];
              for (var i = 30; i < 35; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB17)
              );
              //41159 41163
              var tabB18 = [];
              for (var i = 35; i < 40; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB18)
              );
              //41164 41168
              var tabB19 = [];
              for (var i = 40; i < 45; i++) {
              ...
              this.reserves.bottlesB1.push(
                this.client.registerToString(tabB19)
              );
              //41169 41173
              var tabB21 = [];
              for (var i = 45; i < 50; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB21)
              );
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB22)
              );
              //41179 41183
              var tabB23 = [];
              for (var i = 55; i < 60; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB23)
              );
              //41184 41188
              var tabB24 = [];
              for (var i = 60; i < 65; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB24)
              );
              //41189 41193
              var tabB25 = [];
              for (var i = 65; i < 70; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB25)
              );
              //41194 41198
              var tabB26 = [];
              for (var i = 70; i < 75; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB26)
              );
              //41199 41203
              var tabB27 = [];
              for (var i = 75; i < 80; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB27)
              );
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB28)
              );
              //41209 41213
              var tabB29 = [];
              for (var i = 85; i < 90; i++) {
              ...
              this.reserves.bottlesB2.push(
                this.client.registerToString(tabB29)
              );
            ...
            this.reserves.co2Res1ActVol =
              Math.round(
                this.client.registerToFloat([res2[6], res2[7]]) * 0.001974 * 100
              ) / 100;
            ...
            if (nameId != upcNameId && false) {
              ...
              if (
                ...
                if (
                  ...
                  this.alarm.alrResLowEn = this.client.registerToUint32(
                    res1[65]
                  );
  ...
  async readInterventionCeintureParameters() {
    return new Promise(async (resolve, reject) => {
      //40168
      var res2 = await this.client.readHoldingRegisters(
        this.correspondancesRegistres.upcFwVer.adr,
        1
      );
  ...
  async readGeneralParameters() {
    return new Promise(async (resolve, reject) => {
      ...
      //40401 40449
      var res3 = await this.client.readHoldingRegisters(
        this.correspondancesRegistres.upcTimeZone.adr,
        48
      );
  ...
  readAlarmParameters() {
    return new Promise(async (resolve, reject) => {
      //40169 40294
      var res2 = await this.client.readHoldingRegisters(
        this.correspondancesRegistres.alrResEmptyEn.adr,
        126
      );
    ...
    try {
      ...
      if (mode != "modeTest") {
        ...
        if (nameId != upcNameId) {
          ...
          this.general.upcClock = new Date(
            this.client.registerToUint32([res[11], res[12]]) * 1000
          ).toLocaleDateString("fr-FR", opt);
          ...
          //40022 40023
          this.communicationParameters.comGsmIpAdr = this.int2ip(
            this.client.registerToUint32([res[21], res[22]])
          );
          //40024 40033
          var tabMdmName = [];
          for (var i = 23; i < 33; i++) {
  ...
  async readBloc2() {
    ...
    try {
      ...
      this.reserves.co2Res1ActVol =
        Math.round(
          this.client.registerToFloat([res[35], res[36]]) * 0.001974 * 100
        ) / 100;
      //40159
      ...
      this.reserves.co2Res2ActVol =
        Math.round(
          this.client.registerToFloat([res[43], res[44]]) * 0.001974 * 100
        ) / 100;
      //40167
  ...
  async readBloc4() {
    try {
      ...
      this.reserves.co2Res1StartVol =
        Math.round(
          this.client.registerToFloat([res[59], res[60]]) * 0.001974 * 100
        ) / 100;
      ...
      this.reserves.co2Res2StartVol =
        Math.round(
          this.client.registerToFloat([res[87], res[88]]) * 0.001974 * 100
        ) / 100;
  ...
  async flashFW(file: string, loading: LoadingController) {
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      const load = await loading.create({
        duration: 2000,
        message:
          "Updating firmware : " + ((i / lines.length) * 100).toFixed(1) + " %",
      });
      await load.present();
    }
  }
  async editTrapNum(nbpieges: number, value: number) {
    await this.client
      .setIntInHoldingRegister(
        40015,
        1,
        this.client.getIntFromHoldingRegister(nbpieges, 1)
      )
      .then((data) => {
    ...
    await this.client
      .setFloatInHoldingRegister(
        40018,
        this.client.getFloatFromHoldingRegister(value)
      )
      .then((data) => {
        alert(JSON.stringify(data));
      })
